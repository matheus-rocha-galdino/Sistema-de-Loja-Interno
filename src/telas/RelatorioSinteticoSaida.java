...
public class RelatorioSinteticoSaida extends javax.swing.JPanel {
    ...
    private void carregaTabela() {
        ...
        try {
            String comandoTabela = "select * from venda as V inner join colaborador as C on V.fk_id = C.id where hora_venda  between '" + dataInicial + "' and DATE_ADD('" + dataFinal + "', INTERVAL 1 DAY)";
            ...
            .addGroup(jPanelBodyLayout.createSequentialGroup()
                .addGroup(jPanelBodyLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanelBodyLayout.createSequentialGroup()
                        ...
                        .addGap(0, 0, 0)
                        .addComponent(txtDataCliente, javax.swing.GroupLayout.PREFERRED_SIZE, 142, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(25, 25, 25)
                        .addComponent(jLabel5, javax.swing.GroupLayout.PREFERRED_SIZE, 75, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(0, 0, 0)
                        .addComponent(txtDataCliente2, javax.swing.GroupLayout.PREFERRED_SIZE, 142, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
